...
def processDicom(in_path, out_dir, clobber=False, move=False, verbose=False, debug=False, extension='.dcm', visit_id=None, omit_study_uid=False, omit_series_uid=False, substitute_tag=None, subject_id=None, study_date=None, rename_file=False):
...
'''
    ...
    parser.add_argument("in_paths", help="path to DICOM files to be sorted", nargs="+")
    parser.add_argument("-o", "--out_dir", help="directory where sorted DICOM file will be placed (Required)", required=True)
    ...
    parser.add_argument("--omit_study_uid", help="Do not include StudyInstanceUID in the Study directory name.", action="store_true")
